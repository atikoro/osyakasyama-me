...
- 配信用M4A: `audio/episode-011.m4a`
- 再生時間: 301.800秒
- サンプルレート: 24000 Hz
- チャンネル: 1
- サイズ: 2630626 bytes
- M4A SHA-256: `099b4d9706f3b0cadeea88a6da3f9aa5deec3f0f01258c4811a4def3a893e6de`
- ソースMP3 SHA-256: `f756706dbc00b28d2ecf289916954b30564a012fa3c5dbcce9e25e236ef41ed6`
- Integrated loudness: -16.97 LUFS
- True peak: -2.11 dBTP

## 初期問題と修正

- Misskey／Fediverse、issue、サーバー、コマンド名、cron、バージョン表記を音声向けに修正。
...
- 最終全文: `gpt-4o-transcribe`、60秒、2秒重複、6チャンク
...
scripts/transcribe_episode_audio.sh \
  episodes/011-misskey-admin-tools/audio/episode-011-source.mp3 \
  episodes/011-misskey-admin-tools/review/final
```
