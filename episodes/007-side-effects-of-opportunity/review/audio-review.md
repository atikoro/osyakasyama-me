...
- 配信用M4A: `audio/episode-007.m4a`
- 再生時間: 1171.100秒
- サンプルレート: 24000 Hz
- チャンネル: 1
- サイズ: 10136729 bytes
- M4A SHA-256: `ffa0dee7576d9809838c6bbbc887a82a570132eabe712adbd062f9aeb0e0ea85`
- ソースMP3 SHA-256: `11d40c7466354657129e6d7144fb00326825616d5448ae217e7406a10063e7c0`
- Integrated loudness: -17.11 LUFS
- True peak: -1.05 dBTP

## 初期問題と修正

- 日付、稲盛和夫の引用、節番号、括弧表現、憎悪、まとめの『副作用』脱落を修正。
...
- 初期全文: `gpt-4o-transcribe`、60秒、2秒重複、20チャンク
- 独立初期全文: `gpt-4o-mini-transcribe`、60秒、2秒重複、20チャンク
- 最終全文: `gpt-4o-transcribe`、60秒、2秒重複、20チャンク
...
scripts/transcribe_episode_audio.sh \
  episodes/007-side-effects-of-opportunity/audio/episode-007-source.mp3 \
  episodes/007-side-effects-of-opportunity/review/final
```
