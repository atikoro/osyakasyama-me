...
第5話は、2022年12月1日に公開された「上から来たものを下へ受け流すの社会」です。
...
ここで触れたブログエントリ「知識量と意思決定の質は比例しない話」を含む関連記事へのリンクを、説明欄に掲載しています。
...
俗に言うおばあちゃんの知恵袋は、個人、つまりおばあちゃん自身の持つ知識と言えそうですが、ツイッター上でリツイートした投稿を個人、つまりリツイートした人が持つ知識として扱うには無理がある気がします。
...
そしてそれらは、共感、つまり、いいねを得るために行っていると言っても過言ではありません。
...
SNSで大多数の人がしていることを客観的に表現するなら、上から来たもの、つまりタイムラインを、下へ受け流している。つまり、ロム専、またはリツイートだけなのです。

自分で投稿したとしても、流れ、つまりタイムラインやトレンドに言及した内容が多いのではないでしょうか。もしくは、ただの独り言です。

ですので、SNS上には玉石混交の情報が無限に存在していますが、それぞれの情報はただインターネットの海に放出されるだけで、別に誰かが所有しているわけではありません。厳密にいえば、投稿の著作権は投稿者にありますが、その情報がどう扱われるかは、投稿者の窺い知ることのできないことです。例えば、村上選手がシーズン56号ホームランを打ったという記録は村上選手のものですが、その情報に所有者は存在せず、誰にでも扱うことができます。
...
今回は、Something like blogの「上から来たものを下へ受け流すの社会」を、できるだけ原文のまま朗読してお届けしました。
